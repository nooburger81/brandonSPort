...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#134330] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/cb4030cd-5a59-4438-b827-1f089dedf710" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                ...
                <p className='text-gray-300 py-4'>// Submit the form below or shove off</p>
            </div>
            ...
            <button className='text-white border-2 hover:bg-yellow-400 hover:border-yellow-600 px-4 py-3 my-8 mx-auto flex items-center'>Let's Collaborate</button>
        </form>
    </div>
  )
}
